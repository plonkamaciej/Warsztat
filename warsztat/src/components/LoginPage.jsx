 ...
 // handle login logic here
  ...
  return (
    ...
    <label className='m-auto mt-2 font-extrabold mb-4 text-2xl'>Login</label>
        ...
        <input type='name' placeholder="Username" className='w-full block m-1 px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
      ...
      disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
      invalid:border-pink-500 invalid:text-pink-600
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500' value={password} onChange={(e) => setPassword(e.target.value)} />
